...
//  * @returns bool
//  */
// function ffprobeValidateDefaultMediaInformation(url)    {
//   return FFprobeKit.getMediaInformation(url, errorCallback).then(async (session) => {
//       console.log("FFPROBE")
//       console.log(session)
...
//         isDefault &= videoStream["codec_name"] == VIDEO_DEFAULT_CODEC["codec_name"]
//         isDefault &= videoStream["time_base"] == VIDEO_DEFAULT_CODEC["time_base"]
//         isDefault &= videoStream["width"] == VIDEO_DEFAULT_CODEC["width"]
//         isDefault &= videoStream["height"] == VIDEO_DEFAULT_CODEC["height"]
//         isDefault &= videoStream["r_frame_rate"] == VIDEO_DEFAULT_CODEC["r_frame_rate"]
//         let audioStream = output.stream[1]
//         isDefault &= audioStream["codec_name"] == AUDIO_DEFAULT_CODEC["codec_name"]
//         isDefault &= audioStream["time_base"] == AUDIO_DEFAULT_CODEC["time_base"]
//         isDefault &= audioStream["r_frame_rate"] == AUDIO_DEFAULT_CODEC["r_frame_rate"]
//       } else  {
...
export default class FFmpegWrapper {
  ...
  //   errorCallback,
  // ) {
  //   const isDefault = ffprobeValidateDefaultMediaInformation(videoURI, errorCallback);
  //   if (!isDefault) {
